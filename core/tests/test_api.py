...
class MessageApiTestCase(APITestCase):
    def setUp(self):
        self.test_user1 = User.objects.create(email='u1@mail.com')
        self.test_user1.set_password('u1')
        self.test_user1.save()
        self.test_user2 = User.objects.create(email='u2@mail.com', password='u2')
        self.test_user2.set_password('u2')
        self.test_user2.save()
        self.test_user3 = User.objects.create(email='u3@mail.com', password='u3')
